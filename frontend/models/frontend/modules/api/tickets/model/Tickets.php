...
namespace app\models\frontend\modules\api\tickets\model;
...
class Tickets extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['id'], 'required'],
            [['id'], 'integer'],
            [['name', 'actual', 'depart_date', 'destination', 'distance', 'duration', 'found_at', 'gate', 'number_of_changes', 'origin', 'return_date', 'show_to_affiliates', 'trip_class', 'value'], 'string', 'max' => 45],
            [['id'], 'unique'],
        ];
    }
